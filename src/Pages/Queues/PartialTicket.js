...
const PartialTicket = () => {
    ...
    const handleDueAdjust = (utid,totalPrice,paidAmount) => {
        const obj = {
            uniqueTransID: utid,
                ...
                await axios
                    ...
                    .then((res) => {
                        ...
                        if (res.data.isSuccess === true) {
                            ...
                            toast.success("Due amount adjusted successfully");
                                                            ...
                                                            ticketingList.map((item, index) => {
                                                                return (
                                                                    <tr key={index}>
                                                                        ...
                                                                        <td>{item.ticketingPrice - item.paidAmount}</td>
                                                                        <td className={moment() >= moment(item.dueReturnDate) & (item.ticketingPrice - item.paidAmount) > 0 ? "text-danger" : ""}>{moment(item.dueReturnDate).format("DD-MM-YYYY hh:mm:ss")}</td>
                                                                        ...
                                                                        <td className="text-left">
                                                                            <>
                                                                                ...
                                                                                {
                                                                                    (item.ticketingPrice - item.paidAmount) > 0 ? <>
                                                                                        &nbsp;{" "}
                                                                                        <a href="javascript:void(0)"
                                                                                            title="Due Adjust"
                                                                                            onClick={() =>
                                                                                        ...
                                                                                        >
                                                                                            <Button
                                                                                                ...
                                                                                                p='1'
                                                                                            >
                                                                                                <span style={{ fontSize: "10px" }}>DA</span>
                                                                                            </Button>
                                                                                        </a>
                                                                                    </> :
                                                                                        <> </>
