            ...
            <Center>
                <Container maxW={"6xl"} bg='' mb={'30px'} key={nanoid()} >
                    <Box justifyContent={'center'} mb="20px" key={nanoid()}>
                        <HStack justifyContent={'center'} display='flex' mb='16px' key={nanoid()}>
                            <Text height={'18px'} fontWeight={700} fontSize='20px'>Why</Text>
                            <img src={logo} alt="" width='100px' height={'10px'} />
                        </HStack>
                        <Text textAlign={'center'} display='flex' ml={'50px'} mr='50px' key={nanoid()}>
                            FirstTrip is the country's one of the leading online travel aggregator. We dream of making travel easier for people of all ages.ShareTrip is revolutionising the way you book travel services.
                        </Text>
                    </Box>
