...
const Navbar = () => {
    ...
    const startSignalRConnection = async () => {
        try {
            const signalRConnection = new HubConnectionBuilder()
                .withUrl(environment.signalRNegotiationLink, {accessTokenFactory: () => JSON.parse(localStorage.getItem("token")).token})
            ...
            signalRConnection.on("notification", (data) => {
                ...
                if (data.message && data.message.trim() !== '') {
                    ...
                    toast({
                        ...
                        description: `You have ${data?.unreadCount} new notifications`,
                        status: 'info',
                        isClosable: true,
                        duration: 10000,
                    });
            ...
            await signalRConnection.start()
                ...
                .then(() => {
                    signalRConnection.invoke('getconnectionid')
                        .then((data) => {
            ...
            // await signalRConnection.invoke(environment.signalRConnectionLink, environment.headerToken);
            // startHttpRequest();
    ...
    const startHttpRequest = async () => {
        axios.get(environment.signalRConnectionLink, environment.headerToken)
            .then((data) => {
    ...
    //
    //     await signalRConnection.start();
    //     await signalRConnection.invoke("ConnectWithSignalR");
    //
    // }
